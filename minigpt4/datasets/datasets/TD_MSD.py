...
class TD_MSD(Dataset):
    def __init__(self, vis_processor, text_processor, vis_root, ann_path, dataset='refcoco', splitBy='unc'):
        ...
        # In TD datasets, usually all refs are tumors, but if you are mixing 
        # healthy and tumor slices, filter for tumor IDs here and .extend() the list.
        tumor_ids = [rid for rid in self.ref_ids if "tumor" in rid] # Example condition
        self.ref_ids.extend(tumor_ids * 2) 
